...
saveRDS(df1, "../../data/raw_data/df_departments.rds")
...
#df_total <- df_retail %>%
#  left_join(df_department, by = c("year" = "year"))
#df_total <- merge(df_retail, df_department, by.x = "year", by.y = "year")
df_total <- rbind(df_retail, df_department)
```
